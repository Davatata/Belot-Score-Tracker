...
function createRow(){
	...
	if(!checkBet(contract_amt, attacker_chosen, suit_chosen, special_chosen, team1_points, team1_bonus, team2_points, team2_bonus)) return;
		...
		if(attacker_chosen == team1){
			if(team1_points < contract_amt){
				team1_total = 0;
				if(multiplier == 0){
					team2_total = 162 + team1_bonus + team2_bonus;
				}
				else{
					team2_total = contract_amt*multiplier + team1_bonus + team2_bonus;
				}
			}
			else{
				if(multiplier == 0){
			...
			if(team2_points < contract_amt){
				team2_total = 0;
				if(multiplier == 0){
					team1_total = 162 + team1_bonus + team2_bonus;
				}
				else{
					team1_total = contract_amt*multiplier + team1_bonus + team2_bonus;
				}
			}
			else{
				if(multiplier == 0){
		...
		if(curRow != null) { 
			...
			if(suit_chosen == "A"){
				curRow.find(':nth-child(2)').text("A");
			}
			else 
